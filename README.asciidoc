...
[.small]#(since v1.4.0, Reads the the file in the same directory as DebugTrace.dll in earlier versions)#. +
...
[.small]#*Examples:*# +
`LeaveString = Leave {0}.{1} ({2}:{3:D}) time: {4}` [.small .blue]#*_[Default] (since v1.4.3)_*# +
`LeaveString = Leave {0}.{1} ({2}:{3:D})` [.small .blue]#*_[Default] (before v1.4.3)_*# +
[.small]#*Parameters:*# +
`{0}`: The class name of the caller +
`{1}`: The method name of the caller +
`{2}`: The file name of the caller +
`{3}`: The line number of the caller +
`{4}`: The time since invoking the corresponding `Enter` method [.small .blue]#*_(since v1.4.3)_*# +
...
[.small]#*Examples:*# +
`DateTimeFormat = {0:yyyy-MM-dd HH:mm:ss.fffffffK}` [.small .blue]#*_[Default] (since v1.4.1)_*# +
`DateTimeFormat = {0:yyyy-MM-dd HH:mm:ss.fffK}` [.small .blue]#*_[Default] (before v1.4.1)_*# +
[.small]#*Parameter:*# +
`{0}`: The `DateTime` object +

|`LogDateTimeFormat` +
 +
[.small .blue]#*_(since v1.3.0)_*#
|Output format of date and time when outputting logs +
[.small]#*Examples:*# +
`LogDateTimeFormat = {0:yyyy-MM-dd HH:mm:ss.fff} [{1:D2}] {2}` [.small .blue]#*_[Default] (since v1.4.2)_*# +
`LogDateTimeFormat = {0:yyyy-MM-dd HH:mm:ss.fff}` [.small .blue]#*_[Default] (before v1.4.2)_*# +
[.small]#*Parameter:*# +
`{0}`: The `DateTime` of log output +
`{1}`: The thread ID [.small .blue]#*_(since v1.4.2)_*# +
`{2}`: The log contents [.small .blue]#*_(since v1.4.2)_*# +
